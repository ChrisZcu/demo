 ...
 */
public class BoxMap extends PApplet {
    ...
    public static void main(String[] args) {
        PApplet.main(new String[]{"testApp.BoxMap"});
    }
    ...
    public void setup() {
        ...
        mapDetail = new UnfoldingMap(this, 10, 10, 585, 580, new MapBox.CustomMapBoxProvider(mapStyle));
        ...
        mapOverview = new UnfoldingMap(this, 605, 10, 185, 185, new MapBox.CustomMapBoxProvider(mapStyle));
        ...
        // Static overview map
        mapOverviewStatic = new UnfoldingMap(this, 605, 205, 185, 185, new MapBox.CustomMapBoxProvider(mapStyle));
    }
